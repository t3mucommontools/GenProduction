...
if __name__ == "__main__":
    ...
    config = jobprefix+"_MiniAOD.py"
    with open('miniaodToAOD_config.py', 'r') as file :
            filedata = file.read()
            filedata = filedata.replace('<inputsample>', args.input_sample.split("/")[1]+"_MiniAOD.root") # chomp .py at the end
